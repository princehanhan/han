...
<c:if test="${role == 'admin'}">
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span
                            ...
                            <ul class="submenu">
                                <li class="home">
                                    <a href="javascript:void(0)" name="goods_bookloanlist.do" title="图书借阅管理" class="iframeurl">
                                        <i class="icon-double-angle-right"></i>借阅申请</a>
                                </li>
                                <li class="home">
                                    <a href="javascript:void(0)" name="bookloanlog_list.do" title="图书借阅管理" class="iframeurl">
                                        <i class="icon-double-angle-right"></i>借阅记录</a>
                                </li>
<c:if test="${role == 'admin'}">
                                <li class="home">
