...
<div class="xinxi" style="margin-top: 20px">
    <div class="form-group"><label class="col-sm-3 control-label no-padding-right" >用户名：</label>
        <div class="col-sm-9"><input type="text" name="name" id="website-title" value="${bean.name}" class="col-xs-7 text_info" disabled="disabled">
    ...
    <div class="form-group"><label class="col-sm-3 control-label no-padding-right" >所属班级：</label>
        <div class="col-sm-9"><input type="text" name="bj" id="website-title" value="${bean.bj}" class="col-xs-7 text_info" disabled="disabled">
          </div>
    </div>
    <div class="form-group"><label class="col-sm-3 control-label no-padding-right" >所属系：</label>
        <div class="col-sm-9"><input type="text" name="bj" id="website-title" value="${bean.ssx}" class="col-xs-7 text_info" disabled="disabled">
        </div>
    </div>
    <div class="form-group"><label class="col-sm-3 control-label no-padding-right" >所属专业：</label>
        <div class="col-sm-9"><input type="text" name="bj" id="website-title" value="${bean.zy}" class="col-xs-7 text_info" disabled="disabled">
        </div>
    </div>
    ...
    <div class="form-group"><label class="col-sm-3 control-label no-padding-right" >照片： </label>
        <div class="col-sm-9">
            <img id="website-title" src="${ctx}${bean.rz}" class="col-xs-7 text_info" style="width: 156px; height: 200px"></div>
    </div>
