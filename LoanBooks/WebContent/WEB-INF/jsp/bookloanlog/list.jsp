        ...
        <div class="Ads_lists">
            <table class="table table-striped table-bordered table-hover" id="sample-table">
                ...
                <tr>
                    ...
                    <th width="180px">借阅人</th>
                    <th width="250px">借阅人电话</th>
                ...
                <tr>
                    ...
                    <td class="td-status">${c.jyUser.realName}</td>
                    <td class="td-status">${c.jyUser.phone}</td>
                    <%--<td class="td-manage">--%>
                        <%--<a title="借阅"  href="bookloan_loansave.do?id=${c.id}" class="btn btn-xs btn-info"><i class="fa fa-edit bigger-120"></i></a>--%>
                        <%--&lt;%&ndash;<a title="删除" href="javascript:;" onclick="del(${c.id})" class="btn btn-xs btn-warning"><i class="fa fa-trash  bigger-120"></i></a>&ndash;%&gt;--%>
                    <%--</td>--%>
                </tr>
                </c:forEach>
                </tbody>
