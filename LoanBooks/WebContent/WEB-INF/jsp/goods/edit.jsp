...
<div class="panel admin-panel">
    <div class="panel-head">
        <div class="body-content">
            <form method="post" class="form-x" id="form" action="goods_update.do" enctype="multipart/form-data" onsubmit="return myFrom()">
               <input type="hidden" name="id" value="${bean.id}" />
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" name="name" id="name" value="${bean.name}"/>
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input tips" id="file1" style="width:25%; float:left;" value=""
                               data-toggle="hover" data-place="right" data-image="${bean.fileName1}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input tips" id="file2" style="width:25%; float:left;" value=""
                               data-toggle="hover" data-place="right" data-image="${bean.fileName2}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input tips" id="file3" style="width:25%; float:left;" value=""
                               data-toggle="hover" data-place="right" data-image="${bean.fileName3}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input tips" id="file4" style="width:25%; float:left;" value=""
                               data-toggle="hover" data-place="right" data-image="${bean.fileName4}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input tips" id="file5" style="width:25%; float:left;" value=""
                               data-toggle="hover" data-place="right" data-image="${bean.fileName5}"/>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <textarea class="input" name="js" id="js" data-validate="required:图书介绍" style="width: 500px; height: 160px">${bean.js}</textarea>
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
    ...
    <script>
        function myFrom() {
            ...
            if (name == null || name == "" || itemTypeSecondaryId == null || itemTypeSecondaryId == "") {
                alert("填写完整信息后提交")
                return false
            }
        }
